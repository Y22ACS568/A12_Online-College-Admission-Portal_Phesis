...
<head>
  ...
  <title>Bapatla Engineering College Admission Management System | Search Application</title>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-xl-6 col-lg-12">
                        <fieldset>
                          <h5>Search by Applicant Name / Email ID / Contact Number</h5>
...
WHERE tbladmapplications.ApplicantName LIKE '%$sdata%'
   OR tbluser.MobileNumber LIKE '%$sdata%'
   OR tbluser.Email LIKE '%$sdata%'");
...
?>
                          <tr>
                            ...
                            <td>
                              <a href="view-appform.php?aticid=<?php echo $row['apid']; ?>">View Details</a>
                            </td>
                          </tr>
<?php
    $cnt = $cnt + 1;
...
?>
                          <tr align="center">
                            <td colspan="6" style="color:red; font-size: 16px;">No Record found against this search</td>
                          </tr>
<?php } ?>
