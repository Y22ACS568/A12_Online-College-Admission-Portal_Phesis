...
<head>
  ...
  <title>Bapatla Engineering College Admission Management System|| B/w Dates Report Details</title>
...
<div class="app-content content">
  <div class="content-wrapper">
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">B/w Dates Report of Selected Application</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="content-body">
      ...
      $todate = $_POST['todate'];
      $displayFrom = date("d-m-Y", strtotime($fromdate));
      $displayTo = date("d-m-Y", strtotime($todate));
      ?>

      <h1>B/w Dates Report Details From <?php echo $displayFrom; ?> To <?php echo $displayTo; ?></h1>
      ...
      <table class="table mb-0">
        ...
        $ret = mysqli_query($con, "SELECT 
          ...
          WHERE tbladmapplications.AdminStatus='1'
          AND DATE(tbladmapplications.AdminRemarkDate) BETWEEN '$fromdate' AND '$todate'");
