...
<head>
  ...
  <title>Bapatla Engineering College Admission Management System||Home Page</title>
  <!-- web fonts -->
  <link href="//fonts.googleapis.com/css?family=Work+Sans:100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet">
  <!-- //web fonts -->
  <!-- Favicons -->
  <link rel="icon" href="./assets/images/favicon/bec.ico" type="image/x-icon" />
  <link rel="apple-touch-icon" sizes="180x180" href="./assets/images//favicon/bec.ico">
  <link rel="icon" type="image/png" sizes="32x32" href="./assets/images//favicon/bec.ico">
  <link rel="icon" type="image/png" sizes="16x16" href="./assets/images//favicon/bec.ico">
              ...
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg mx-auto text-center">
                    <h5>Better BEC Education For A Better World</h5>
      ...
      <div class="container py-md-3">
        ...
        <div class="calltoaction-20-content row">
          <div class="column center-align-self col-lg-6 pr-lg-5">
            <h5 class="editContent">Welcome To Our BEC Campus</h5>
            <?php
