...
(1, 'aboutus', 'About Us', 'The Bapatla Engineering College(Autonomous), one of the seven educational institutions sponsored by the Bapatla Education Society, was established in 1981 with a vision to impart quality technical education and is affiliated to Acharya Nagarjuna University. The College is a little away from the din and bustle of Bapatla, a town with a historic and hoary past, about 75 Km. south of Vijayawada on Chennai-Vijayawada rail route. The college offers B.Tech. Programmes in 9 branches of Engineering- Civil Engineering, Computer Science and Engineering, CSE(Cyber Security), CSE(Data Science), CSE(AIML), Electronics & Communication Engineering, Electrical and Electronics Engineering, Information Technology and Mechanical Engineering. CE, CSE, ME & EEE Programmes NBA accredited FOUR times.  ECE programme NBA accrediated THREE times. IT programme NBA accrediated ONCE', NULL, NULL, NULL, ''),
(2, 'contactus', 'Contact Us', 'Street No. 8, Sector B, nellore, Andhra pradhesh', 'vamsitallika123@gmail.com', 8500166525, NULL, '10:30 am to 4:30 pm');
